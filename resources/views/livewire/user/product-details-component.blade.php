                    ...
                    <div class="product__details-wrapper">
                        <div class="product__details">
                            <h3 class="product__details-title">
                                <a href="product-details.html">Smart Mobile Phone 7/7plus/8/8plus/X/Xr W 32 to
                                    128GB</a>
                            </h3>
                            ...
                            <div class="product__details-des mb-30">
                                <p>Typi non habent claritatem insitam, est usus legentis in iis qui facit eorum
                                    ...
                                    saepius. Claritas est etiam processus. Lorem Ipsum has been the industry's standard
                                    dummy text ever since the 1500s, when anunknown printer took a galley of type and
                ...
                <div class="col-xl-12">
                    <div class="brand__slider owl-carousel">
                        <div class="brand__item">
                            <img src="{{ 'user/assets/img/brand/brand-1.jpg' }}" alt="">
                        </div>
                        <div class="brand__item">
                            <img src="{{ 'user/assets/img/brand/brand-2.jpg' }}" alt="">
                        </div>
                        <div class="brand__item">
                            <img src="{{ 'user/assets/img/brand/brand-3.jpg' }}" alt="">
                        </div>
                        <div class="brand__item">
                            <img src="{{ 'user/assets/img/brand/brand-4.jpg' }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
