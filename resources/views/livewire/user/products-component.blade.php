                                    ...
                                    <ul>
                                        <li class="product__sm-item d-flex align-items-center">
                                            <div class="product__sm-thumb mr-20">
                                                <a href="product-details.html">
                                                    <img src="{{ asset('user/assets/img/shop/product/sm/product-sm-1.jpg') }}" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <li class="product__sm-item d-flex align-items-center">
                                            <div class="product__sm-thumb mr-20">
                                                <a href="product-details.html">
                                                    <img src="{{ asset('user/assets/img/shop/product/sm/product-sm-2.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="product__sm-content">
                                                <h3 class="product__sm-title">
                                        ...
                                        <div class="row">
                                                 ...
                                                 <div class="product__item white-bg mb-30">
                                                     <div class="product__thumb p-relative">
                                                         <a href="product-details.html" class="w-img">
                                                             <img src="{{ asset('user/assets/img/shop/product/product-1.jpg') }}" alt="product">
                                                             <img class="second-img" src="{{ asset('user/assets/img/shop/product/product-2.jpg') }}" alt="product">
                                                         </a>
                                            ...
                                            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4">
                                                 <div class="product__item white-bg mb-30">
                                                     <div class="product__thumb p-relative">
                                                         <a href="product-details.html" class="w-img">
                                                             <img src="{{ asset('user/assets/img/shop/product/product-3.jpg') }}" alt="product">
                                                             <img class="second-img" src="{{ asset('user/assets/img/shop/product/product-4.jpg') }}" alt="product">
                                                         </a>
                                                         <div class="product__action p-absolute">
                                                             <ul>
                                                                 <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
                                            ...
                                            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4">
                                                 <div class="product__item white-bg mb-30">
                                                     <div class="product__thumb p-relative">
                                                         <a href="product-details.html" class="w-img">
                                                             <img src="{{ asset('user/assets/img/shop/product/product-5.jpg') }}" alt="product">
                                                             <img class="second-img" src="{{ asset('user/assets/img/shop/product/product-6.jpg') }}" alt="product">
                                                         </a>
                                                         <div class="product__action p-absolute">
                                                             <ul>
                                                                 <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
                                            ...
                                            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4">
                                                 <div class="product__item white-bg mb-30">
                                                     <div class="product__thumb p-relative">
                                                         <a href="product-details.html" class="w-img">
                                                             <img src="{{ asset('user/assets/img/shop/product/product-7.jpg') }}" alt="product">
                                                             <img class="second-img" src="{{ asset('user/assets/img/shop/product/product-8.jpg') }}" alt="product">
                                                         </a>
                                                         <div class="product__action p-absolute">
                                                             <ul>
                                                                 <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
                                            ...
                                            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4">
                                                 <div class="product__item white-bg mb-30">
                                                     <div class="product__thumb p-relative">
                                                         <a href="product-details.html" class="w-img">
                                                             <img src="{{ asset('user/assets/img/shop/product/product-9.jpg') }}" alt="product">
                                                             <img class="second-img" src="{{ asset('user/assets/img/shop/product/product-10.jpg') }}" alt="product">
                                                         </a>
                                                         <div class="product__action p-absolute">
                                                             <ul>
                                                                 <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
                                            ...
                                            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4">
                                                 <div class="product__item white-bg mb-30">
                                                     <div class="product__thumb p-relative" >
                                                         <a href="product-details.html" class="w-img">
                                                             <img src="{{ asset('user/assets/img/shop/product/product-11.jpg') }}" alt="product">
                                                             <img class="second-img" src="{{ asset('user/assets/img/shop/product/product-12.jpg') }}" alt="product">
                                                         </a>
                                                         <div class="product__action p-absolute">
                                                             <ul>
                                                                 <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
                                            ...
                                            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4">
                                                 <div class="product__item white-bg mb-30">
                                                     <div class="product__thumb p-relative" >
                                                         <a href="product-details.html" class="w-img">
                                                             <img src="{{ asset('user/assets/img/shop/product/product-24.jpg') }}" alt="product">
                                                             <img class="second-img" src="{{ asset('user/assets/img/shop/product/product-13.jpg') }}" alt="product">
                                                         </a>
                                                         <div class="product__action p-absolute">
                                                             <ul>
                                                                 <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
                                            ...
                                            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4">
                                                 <div class="product__item white-bg mb-30">
                                                     <div class="product__thumb p-relative" >
                                                         <a href="product-details.html" class="w-img">
                                                             <img src="{{ asset('user/assets/img/shop/product/product-14.jpg') }}" alt="product">
                                                             <img class="second-img" src="{{ asset('user/assets/img/shop/product/product-15.jpg') }}" alt="product">
                                                         </a>
                                                         <div class="product__action p-absolute">
                                                             <ul>
                                                                 <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
                                            ...
                                            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4">
                                                 <div class="product__item white-bg mb-30">
                                                     <div class="product__thumb p-relative" >
                                                         <a href="product-details.html" class="w-img">
                                                             <img src="{{ asset('user/assets/img/shop/product/product-16.jpg') }}" alt="product">
                                                             <img class="second-img" src="{{ asset('user/assets/img/shop/product/product-17.jpg') }}" alt="product">
                                                         </a>
                                                         <div class="product__action p-absolute">
                                                             <ul>
                                                                 <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
                                            ...
                                            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4">
                                                 <div class="product__item white-bg mb-30">
                                                     <div class="product__thumb p-relative" >
                                                         <a href="product-details.html" class="w-img">
                                                             <img src="{{ asset('user/assets/img/shop/product/product-18.jpg') }}" alt="product">
                                                             <img class="second-img" src="{{ asset('user/assets/img/shop/product/product-19.jpg') }}" alt="product">
                                                         </a>
                                                         <div class="product__action p-absolute">
                                                             <ul>
                                                                 <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
                                            ...
                                            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4">
                                                 <div class="product__item white-bg mb-30">
                                                     <div class="product__thumb p-relative" >
                                                         <a href="product-details.html" class="w-img">
                                                             <img src="{{ asset('user/assets/img/shop/product/product-20.jpg') }}" alt="product">
                                                             <img class="second-img" src="{{ asset('user/assets/img/shop/product/product-21.jpg') }}" alt="product">
                                                         </a>
                                                         <div class="product__action p-absolute">
                                                             <ul>
                                                                 <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
                                            ...
                                            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4">
                                                 <div class="product__item white-bg mb-30">
                                                     <div class="product__thumb p-relative" >
                                                         <a href="product-details.html" class="w-img">
                                                             <img src="{{ asset('user/assets/img/shop/product/product-22.jpg') }}" alt="product">
                                                             <img class="second-img" src="{{ asset('user/assets/img/shop/product/product-23.jpg') }}" alt="product">
                                                         </a>
                                                         <div class="product__action p-absolute">
                                                             <ul>
                                                                 <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
                                        ...
                                        <div class="row row-cols-xxl-5 row-cols-xl-4 row-cols-lg-3 row-cols-md-4">
                                            ...
                                            <div class="col">
                                                 <div class="product__item white-bg mb-30">
                                                     <div class="product__thumb p-relative" >
                                                         <a href="product-details.html" class="w-img">
                                                             <img src="{{ asset('user/assets/img/shop/product/product-2.jpg') }}" alt="product">
                                                             <img class="second-img" src="{{ asset('user/assets/img/shop/product/product-1.jpg') }}" alt="product">
                                                         </a>
                                                         <div class="product__action p-absolute">
                                                             <ul>
                                                                 <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
                                            ...
                                            <div class="col">
                                                 <div class="product__item white-bg mb-30">
                                                     <div class="product__thumb p-relative" >
                                                         <a href="product-details.html" class="w-img">
                                                             <img src="{{ asset('user/assets/img/shop/product/product-23.jpg') }}" alt="product">
                                                             <img class="second-img" src="{{ asset('user/assets/img/shop/product/product-7.jpg') }}" alt="product">
                                                         </a>
                                                         <div class="product__action p-absolute">
                                                             <ul>
                                                                 <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
                                            ...
                                            <div class="col">
                                                 <div class="product__item white-bg mb-30">
                                                     <div class="product__thumb p-relative" >
                                                         <a href="product-details.html" class="w-img">
                                                             <img src="{{ asset('user/assets/img/shop/product/product-4.jpg') }}" alt="product">
                                                             <img class="second-img" src="{{ asset('user/assets/img/shop/product/product-23.jpg') }}" alt="product">
                                                         </a>
                                                         <div class="product__action p-absolute">
                                                             <ul>
